...
CC = ['gcc-4.9']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-O0', '-ggdb', '-g3', '-std=gnu++11', '-I./src/applications', '-I/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/../../../../', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['g++-4.9']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-std=gnu++11', '-I./src/applications', '-I/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/../../../../', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
NS3_EXECUTABLE_PATH = ['/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/build/src/emu', '/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/build']
...
cfg_files = ['/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/build/ns3/config-store-config.h', '/zhangzhao/Lab/astra-sim/extern/network_backend/ns3/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
